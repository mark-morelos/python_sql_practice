'''
An extra day is added to the calendar almost every 4 years as February 29, and the day is called a
...
In the Gregorian calendar, 3 conditions are used to identify leap year:
...
Note that the code stub provided reads from STDIN and passes arguments to the is_leap function. It
